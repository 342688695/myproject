<template>
  <div class="hot-key-wrapper" ref="wrapper">
      ...
      <li class="hot-key-li" v-for="(list,index) in hotkeyList" :key="index">
        ...
        <div class="key-content-warpper">
          <div class="content-name">
            <h1><span class="name-style">{{list.nickname}}</span><span class="fouse" v-show="!list.attstatus"><i class="iconfont icon-jia"></i>关注</span><span class="nofouse" v-show="list.attstatus">已关注</span></h1>
    ...
    <div class="share-btn" @click="turnShare"><i class="iconfont icon-share"></i></div>
  </div>
</template>
...
import { gethotKeyDetail } from '../../api/hotkey.js'
...
export default {
  ...
  methods: {
    ...
    _inithotKeyDetail () {
      gethotKeyDetail(this.userid, this.token, this.dateTime).then((res) => {
